...
Welcome to `otp-cli` contributor's guide.
...
If you experience bugs or general issues with `otp-cli`, please have a look
...
You can help improve `otp-cli` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`otp-cli` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `otp-cli`'s files. While this mechanism can
...
```
conda create -n otp-cli python=3 six virtualenv pytest pytest-cov
conda activate otp-cli
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/otp-cli.git
   cd otp-cli
   ```
...
5. Install [pre-commit]:
   ...
   `otp-cli` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/otp-cli
[issue tracker]: https://github.com/<USERNAME>/otp-cli/issues
